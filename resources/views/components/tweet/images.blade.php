            ...
            @foreach($images as $image)
                <div class="w-1/6 px-2 mt-5">
                    <div class="bg-gray-400">
                        <a @click="$dispatch('img-model', { imgModelSrc: '{{ asset('storage/images/' . $image->name) }}' })"
...
@once
    <div x-data="{ imgModel : false, imgModelSrc : '' }">
        <div
            ...
            <div @click.away="imgModel = ''" class="flex flex-col max-w-3xl max-h-full overflow-auto">
                ...
                <div class="p-2">
                    <img class="object-contain h-1/2-screen" :alt="imgModelSrc" :src="imgModelSrc">
                </div>
            </div>
        </div>
    </div>
